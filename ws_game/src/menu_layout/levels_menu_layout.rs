...
use ws_core::{
    layout::entities::{IDEAL_WIDTH, TOP_BAR_ICON_SIZE, IDEAL_HEIGHT},
...
#[derive(
    Debug, Clone, Copy, PartialEq, Eq, Hash, PartialOrd, Ord, Display,
)]
...
impl LayoutStructure for LevelsMenuLayoutEntity {
    ...
    fn iter_all(_context: &Self::Context) -> Self::Iterator {
        ...
        [Self::DailyChallenge, Self::Tutorial, Self::AdditionalLevel(LevelGroup::GlobalLocation), Self::AdditionalLevel(LevelGroup::HistoryMythology), Self::Back ].into_iter()
    }
}
