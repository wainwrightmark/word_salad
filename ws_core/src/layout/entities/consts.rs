...
pub const RECORDING_BUTTON_MIN_SIZE: f32 = 15.0;
pub const RECORDING_BUTTON_MAX_SIZE: f32 = 30.0;
...
pub const TUTORIAL_TEXT_FONT_SIZE: f32 = 16f32;
pub const TUTORIAL_TITLE_FONT_SIZE: f32 = 18f32;
