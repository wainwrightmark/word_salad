...
pub const CONGRATS_ENTITY_STATISTIC_HEIGHT: f32 = 40.0;
pub const CONGRATS_ENTITY_STATISTIC_WIDTH: f32 = 40.0;

pub const CONGRATS_ENTITY_VERTICAL_GAP: f32 = 20.0;

pub const CONGRATS_ENTITY_BUTTON_HEIGHT: f32 = 40.0;
pub const CONGRATS_ENTITY_BUTTON_WIDTH: f32 = 80.0;
